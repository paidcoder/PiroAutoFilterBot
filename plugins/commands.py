...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Cʜᴀɴɴᴇʟ', url=f"https://t.me/{CLINK}"),
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "Join Our Channel to get movies 🍿", url=invite_link.invite_link
                )
            ]
        ]
        ...
        if message.command[1] != "subscribe" or message.command[1] != "send_all":
            try:
                ...
                btn.append([InlineKeyboardButton("✅ Done ", url=f"https://t.me/{temp.U_NAME}?start={message.command[1]}")])
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ UPDATEDS ⚔️', url="https://t.me/moviemateeupdates") ] ] ),
            )
        return
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url="https://t.me/moviemateeupdates") ] ] ),
