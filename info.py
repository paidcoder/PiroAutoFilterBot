...
# Bot images & videos
PICS = (environ.get('PICS', 'https://telegra.ph/file/b9e4fcaa1fa8cd5ad41df.jpg')).split()
NOR_IMG = environ.get("NOR_IMG" , "https://telegra.ph/file/1b49226061ba6716d4184.jpg")
...
auth_channel = environ.get('AUTH_CHANNEL', "-1001737619508")
...
# Others 
ALINK = environ.get('ALINK', '+Ykku2lJTNnMwZWY1')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001646134279))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+kYVxWWDsUWA2YjBl')
