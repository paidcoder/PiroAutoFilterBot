...
BOT_TOKEN = environ.get('BOT_TOKEN', '6968954612:AAE4I68LmXVpTyj15ShWyZeF1zt9TmciXd')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))
# Bot images & videos
PICS = (environ.get('PICS', 'https://telegra.ph/file/b83858d2e54333e18803f.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1980321098 5408556017').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001603357699').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', "-1001937608425")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dot:pass@cluster0.c3yuymi.mongodb.net/?retryWrites=true&w=majority")
